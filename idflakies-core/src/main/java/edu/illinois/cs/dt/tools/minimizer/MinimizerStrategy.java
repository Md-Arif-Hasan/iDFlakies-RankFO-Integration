...
public enum MinimizerStrategy {
    ...
    public HeuristicType heuristic() {
        switch (this) {
            case RANKFO_PLUS_ONE:
                return HeuristicType.PLUS_ONE;
            case RANKFO_METHODS:
                return HeuristicType.METHODS;
            case RANKFO_DISTANCE_D:
                return HeuristicType.DISTANCE;
            case RANKFO_COMBINED_P1_D:
                return HeuristicType.COMBINED_PLUS_ONE_DISTANCE;
            case RANKFO_COMBINED_M_D:
                return HeuristicType.COMBINED_METHODS_DISTANCE;
            default:
